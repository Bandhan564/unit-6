...
const EditableRow = ({ country,getData }) => {
  ...
  const handleEditFormSubmit = (e) => {
    ...
    axios.put(`http://localhost:8080/country/${country.id}`,editChangeForm).then(() => Navigate("/"))
  }
  ...
  return (
    <tr>
      ...
      <td>
        <button className="btn btn-outline-1" onClick={handleEditFormSubmit}>Save</button>
      </td>
    </tr>
  );
};
